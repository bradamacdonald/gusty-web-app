...
const NAV_ITEMS = [
  { id: 'location', label: 'Location', href: 'forecast.html', icon: ICONS.location },
...
/**
 * Mount the shared bottom navigation bar.
 * @param {string} activeId - 'location' | 'search' | 'saved' | 'settings'
 * @param {HTMLElement|string} [target] - element or selector (default: #bottom-nav)
 */
export function mountBottomNav(activeId, target = '#bottom-nav') {
